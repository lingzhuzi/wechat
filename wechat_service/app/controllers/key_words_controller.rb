...
class KeyWordsController < ApplicationController
  before_action :set_wx_key_word, only: [:show, :edit, :update, :destroy]

  # GET /key_words
  # GET /key_words.json
  def index
    app = App.find(params[:app_id])
    @key_words = app.key_words.all
  end
  ...
  private
    ...
    def key_word_params
      params.require(:key_word).permit(:key, :content, :app_id)
    end
end
